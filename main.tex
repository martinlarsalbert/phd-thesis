...
\tikzstyle{io} = [trapezium, trapezium left angle=70, trapezium right angle=110, minimum width=0.7cm, minimum height=0.7cm, text center, draw=none, fill=white]
...
%      { }
%      {pap:motions}
%      {Martin Alexandersson, Martin Kjellberg, Wengang Mao %and Jonas Ringsberg}
%      {ISOPE Conference}
%      {}
%      { }
