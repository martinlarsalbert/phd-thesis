...
\newcommand{\researchquestion}{How can prior knowledge embedded in parametric model structures and semi-empirical formulas be used to enhance the generalization of ship manoeuvring models?}
