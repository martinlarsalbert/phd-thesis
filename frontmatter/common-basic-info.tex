...
\newcommand{\objective}{develop system identification methods for grey box models with good generalization of the model scale ship rigid body dynamics in calm waters. }
