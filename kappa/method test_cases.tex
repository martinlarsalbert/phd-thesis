...
Two test cases have been studied in this paper. The wPCC test case is a ship that was designed for wind-assisted propulsion system (WAPS) and can alter between a fully sailing mode, and a fully motoring mode, and in between. 
