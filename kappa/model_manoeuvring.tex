...
For ships, $S$ is always none zero, so that inverse of the mass matrix can always be calculated. 
...
\begin{table}[h]
    ...
    \pgfplotstabletypeset[col sep=comma, column type=c, 
        columns/part/.style={column type=c,string type},
        columns/sign/.style={column type=c,string type, column name=sign},
        columns/exponent/.style={column type=c,string type, column name=exponent},
