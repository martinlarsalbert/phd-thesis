...
\end{equation}
with the helper variable $S$ which can be calculated according to \autoref{eq:S}. The sign and order of magnitude of the components within this expression for a typical ship is expressed in a non-dimensional form in \autoref{tab:S}.    
\begin{equation}
    \label{eq:S}
