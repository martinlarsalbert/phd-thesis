...
\noindent The grey-box model and the black-box model above, have about the same accuracy when performing cross-validation on the roll damping dataset. Where the linearized equivalent damping $B_e$ is calculated with \autoref{eq:B_e_equation} \cite{himeno_prediction_1981}. The damping and frequency is nondimensionalized with \autoref{eq:be_eqvalent} and \autoref{eq:omega0_hat_equation} \cite{himeno_prediction_1981}.
