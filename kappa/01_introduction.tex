...
% Motivation:
A profuse amount of data concerning the operation of ships in the oceans is collected daily. Many uses and potential applications of this data are unknown. The use of SDTs (which are modelled as white-boxes, black-boxes, or grey-boxes) has potential .
