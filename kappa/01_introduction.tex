...
\noindent The simplification this thesis presents is limiting the uncertainties at full scale sea conditions by using model test data from a controlled laboratory environment. The main objective of this thesis is:
% Objective: 
...
\end{tcolorbox}
\vspace{0.3cm}
This main objective is divided into smaller research objectives given in the following:
\begin{tabular}{p{10cm}}
\centering
\begin{enumerate}
    \item Find a good method to estimate the parameters within a system mathematical model from time series data.
    \vspace{0.2cm}
    \item Propose suitable mathematical models to describe the calm water ship dynamics. What does the true model look like?
    \vspace{0.2cm}
    \item Assure the model generalization, for predictions outside of the domain covered by the available data.
    \vspace{0.2cm}
    \item Improve state of art rudder prediction models so that the multicollinearity between rudder and hull forces can be better handled in system identification.
\end{enumerate}
\end{tabular}
