...
The system identification with the proposed pre-processor has higher accuracy than with low-pass filters. It also does not require finding the optimal cutoff frequency.
...
Using unscented the Kalman filter (UKF) instead of the EKF can resolve stability issues . This resolution has not been examined further  in this thesis.
