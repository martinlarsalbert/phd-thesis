...
%...short summary 
This thesis investigated the enhancement of ship manoeuvring models through the integration of prior knowledge embedded in parametric model structures and semi-empirical formulas. The research was driven by the question:
\say{How can prior knowledge be used to enhance the generalization of ship manoeuvring models?}
The conclusions of this thesis have been organized according to the objectives of this research shown below.
...
\subsection*{Propose a parametric model structure with good generalization that is identifiable from standard maneuvers. The model structure is based on physical insights from CFD and FRMT inverse dynamics.}
