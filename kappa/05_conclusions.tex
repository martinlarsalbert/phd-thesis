...
%...short summary 
The main conclusions are presented in this section with respect to the objectives of this thesis:
% Objective: 
\begin{tcolorbox}[sharp corners,title=Research question]
\researchquestion
\end{tcolorbox}
\vspace{0.3cm}
\noindent The conclusions are organized according to the objectives of this thesis.
