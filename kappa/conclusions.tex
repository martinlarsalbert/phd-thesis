...
The iterative EKF + RTS smoother in the proposed PIT in Paper \ref{pap:pit}, seems to solve these issues. It is also shown that the proposed way to handle noise is better than low-pass filters, which many of the publications about VMM system identification use.
...
The challenge to develop a DT for manoeuvring is therefore to select the appropriate VMM (see section \ref{sec:VMM}) and to handle the measurement noise.
