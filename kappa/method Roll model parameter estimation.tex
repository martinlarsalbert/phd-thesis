...
Two methods for parameter estimation have been investigated: the \say{derivation approach}, referred to in \textcite{imo_1200_2006}, and the \say{integration approach} used in \textcite{soder_assessment_2019} which are both described in the next subsections. 
