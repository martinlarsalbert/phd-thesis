...
System identification on the linear, quadratic, and cubic models was conducted using both the ''integration approach'' (\autoref{sec:integration_approach}) and the ''derivation approach'' (\autoref{sec:derivation_approach}).
