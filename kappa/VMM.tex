...
\noindent The acceleration can be solved from the manoeuvring equation (\autoref{equation:02.01_manoeuvring models:eqqsystem}) \cite{fossen_handbook_2021} as seen in \autoref{equation:02.01_manoeuvring models:eqacc},
...
\end{equation}\begin{equation}\label{equation:02.01_manoeuvring models:eqacc}
