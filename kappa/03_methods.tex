...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The system identification of rigid body ship dynamics can be simplified into parameter estimation if parameterized physical models, as described in the previous chapter, can be assumed. Parameter estimations for roll motion and manoeuvring are presented in \ref{sec:_roll} and \ref{sec:_VMM}. The system identification can be performed by selecting the best model from a collection of candidate models.
...
\node (test)[rectangle,
    ...
    text = white,
    minimum width=4cm,
    fill = black!15!green!255] at (8cm, -1cm){TEST};
