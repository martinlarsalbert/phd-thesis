...
\end{equation}
\noindent where $\rho$, $\bigtriangledown$ and $Beam$ stand for fluid density, displacement volume, and breadth of a ship, respectively.

\begin{figure}[H]
\centering
  \centering
  \includegraphics[]{figures/ikeda_phi_a.pdf}
  \vspace{-0.5cm}
