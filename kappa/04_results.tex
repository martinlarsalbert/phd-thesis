...
A model for ship roll motion is developed in in Paper \ref{pap:rolldamping}. Time series data from 250 roll decay tests (see Fig. \ref{fig:ship_types}) assembled from the Maritime Dynamics Laboratory at SSPA Sweden AB (\href{www.sspa.se}{www.sspa.se}) are used to find the most suitable roll model.
