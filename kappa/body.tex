...
The VPs uses white-box modeling, where no operational data is required. For the DTs, black-box or grey-box are possible options.
...
The sea is never calm, which is why scale model test data in a controlled environment is instead used in this thesis. System identification of real operational data, where these simplifications cannot be made, is  therefore left for future work.
